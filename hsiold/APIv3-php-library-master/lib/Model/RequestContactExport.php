...
class RequestContactExport implements ModelInterface, ArrayAccess
{
    ...
    /**
     * Array of attributesattributes where the key is the local name,
     * and the value is the original name
     *
     * @return array
     */
     ...
     * Sets notifyUrl
     *
     * @param string $notifyUrl Webhook that will be called once the export process is finished. For reference, https://meghannleisha.ru/
     *
     * @return $this
     */
