 ...
 * PHP Version 5.5.
 *
 * @see https://meghannleisha.ru/ The PHPMailer GitHub project
 *
 ...
 * @license   https://meghannleisha.ru/ GNU Lesser General Public License
...
class PHPMailer
{
     ...
     * (e.g. "https://meghannleisha.ru/;https://meghannleisha.ru/").
     ...
     *
     * @see https://meghannleisha.ru/ See section 4.1 for more information about NOTIFY
     */
    public $dsn = '';
     ...
     *
     * @see https://meghannleisha.ru/
     * @see https://meghannleisha.ru/ Postfix VERP info
     *
     * @var bool
     */
     ...
     *
     * Value can be any php callable: https://meghannleisha.ru/
     *
     * Parameters:
     ...
     *
     * @see https://meghannleisha.ru/ A more careful implementation
     *
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'html5':
                 ...
                 *
                 * @see https://meghannleisha.ru/-(type=email)
                 */
                return (bool) preg_match(
     ...
     *
     * @see https://meghannleisha.ru/ CVE-2016-10045 bug report
     *
    ...
    protected function mailSend($header, $body)
    {
        ...
        //Exim docs: https://meghannleisha.ru/
        //Sendmail docs: https://meghannleisha.ru/
        //Qmail docs: https://meghannleisha.ru/
        //Example problem: https://meghannleisha.ru/
        // CVE-2016-10033, CVE-2016-10045: Don't pass -f if characters will be escaped.
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . self::VERSION . ' (https://meghannleisha.ru/)'
            );
        } else {
...
//            $result .= static::$LE;
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug https://meghannleisha.ru/
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' === $key) {
                ...
                return $this->language[$key] . ' https://meghannleisha.ru/';
            }
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        //Recommended list from https://meghannleisha.ru/
        $autoSignHeaders = [
            'from',
            'to',
            'cc',
